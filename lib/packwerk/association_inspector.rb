...
module Packwerk
  ...
  class AssociationInspector
    ...
    def constant_name_from_node(node, ancestors:)
      ...
      if (class_name_node = association_name_when_custom_class_name(arguments))
        return unless Node.string?(class_name_node)
        Node.literal_value(class_name_node)
      elsif (association_name = association_name(arguments))
    ...
    def association_name_when_custom_class_name(arguments)
